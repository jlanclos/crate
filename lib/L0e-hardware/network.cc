...
//   wifiConnectHandler = WiFi.onStationModeGotIP(std::bind(&networkService::onWifiConnect, this,
//   std::placeholders::_1)); wifiDisconnectHandler =
...
//     mqttClient->onMessage(std::bind(&networkService::onMqttMessage, this, std::placeholders::_1,
//     std::placeholders::_2,
...
// void networkService::onMqttMessage(char* topic, char* payload, AsyncMqttClientMessageProperties properties, size_t
// len,
